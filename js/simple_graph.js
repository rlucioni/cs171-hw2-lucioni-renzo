...
var accessToken, allBranchNames, branch, branchName, branches, branchesUrl, candidateNode, canvasHeight, canvasWidth, colors, commit, commits, commitsUrl, contributors, focusNode, force, forceLayout, getData, graph, graphUpdate, i, indexScale, j, linearLayout, links, margin, metadata, name, nodes, parent, parseLinkHeader, rootUrl, rootUser, sha, svg, tick, yScale, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2,
...
indexScale = d3.scale.linear().domain([0, graph.nodes.length]).range([0, canvasWidth]);
...
nodes.on("mouseout", function(d, i) {
  return d3.select(this).transition().duration(500).style("fill", colors(d.branch));
});
