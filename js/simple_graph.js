...
var accessToken, branch, branches, branchesUrl, canvasHeight, canvasWidth, categoryColor, categorySize, commitsUrl, contributors, fill, force, forceLayout, fork, forks, forksUrl, getData, graph, graphUpdate, lineCatLayout, lineLayout, link, node, numCats, numNodes, parseLinkHeader, radialLayout, randomLayout, rootUrl, rootUser, svg, tick, _i, _j, _k, _len, _len1, _len2;
...
for (_j = 0, _len1 = forks.length; _j < _len1; _j++) {
  ...
  branches = getData(branchesUrl);
  for (_k = 0, _len2 = branches.length; _k < _len2; _k++) {
    branch = branches[_k];
