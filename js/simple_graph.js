...
var accessToken, allBranchNames, allTimestamps, branch, branchName, branches, branchesUrl, candidateNode, canvasHeight, canvasWidth, colors, commit, commits, commitsUrl, contributors, duplicate, focusNode, force, forceLayout, getData, graph, graphUpdate, i, indexScale, j, labels, line, linearLayout, links, margin, metadata, name, nodes, parent, parseLinkHeader, repoName, rootUrl, rootUser, scale, sha, storedCommit, svg, tick, timeScale, title, yScale, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4,
